...
export default function Header({ pathname }: { pathname: string }) {
  ...
  return <header className="sticky top-0 w-full z-50 backdrop-blur-xl bg-surface/80">
    <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-16 w-full max-w-container-max mx-auto">
      ...
      <a href="/" className="font-display-lg-mobile text-display-lg-mobile md:font-display-lg md:text-display-lg tracking-tighter text-primary text-center flex-1">INSTASTORE</a>
